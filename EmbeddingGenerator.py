...
for i in tqdm(range(0, len(chunks), batch_size)):
    ...
    finalList.extend([x[0]['type'],x[0]['title'],x[0]['text'],x[0]['chunk'],x[1]] for x in list(zip(meta_batch, embeds)))

df = pd.DataFrame(finalList,columns=['DocumentType','DocumentTitle','Content','Chunk','Embeddings'])
