...
def convertPDFToText(file_path):
    ...
    opts = ClientOptions(api_endpoint=f"{gcpocr_cred.location}-documentai.googleapis.com")
    client = documentai.DocumentProcessorServiceClient(client_options=opts)
    name = client.processor_path(gcpocr_cred.project_id, gcpocr_cred.location, gcpocr_cred.processor_id)
